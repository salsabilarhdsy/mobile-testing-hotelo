...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Data tidak ditemukan</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Data tidak ditemukan' or . = 'Data tidak ditemukan')]</locator>
